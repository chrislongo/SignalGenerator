...
- **Jogwheel** — Rotary frequency control with configurable step increments (0.1, 1, 10, 100 Hz)
...
Built with SwiftUI and AVAudioEngine. The audio engine uses an `AVAudioSourceNode` render callback for direct sample-level synthesis at 48 kHz — lowest possible latency with no intermediate buffers.
